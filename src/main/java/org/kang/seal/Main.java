...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //1.生成公章
        try {
            SealUtil.buildAndStoreSeal(configuration, "C:\\Users\\Dell\\Desktop\\小图标\\qr\\公章.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        font.setFontSize(120).setBold(true).setFontText("尚方宝剑");
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "C:\\Users\\Dell\\Desktop\\小图标\\qr\\私章.png");
    }
